    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2024, 1, 8, 21, 54, 58, 968, DateTimeKind.Local).AddTicks(1643), null, 4, "ahmet.yilmaz@email.com", "5555123456", true, false, 34, "Ahmet", "(555) 512-3456", 4, "100", "Yılmaz" },
                    { 2, 0, new DateTime(2024, 1, 8, 21, 54, 58, 968, DateTimeKind.Local).AddTicks(1646), null, 4, "ayse.kaya@email.com", "5555234567", true, false, 41, "Ayşe", "(555) 523-4567", 3, "101", "Kaya" }
                });

            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "AppointmentDate", "AppointmentHour", "AppointmentID", "CreatedDate", "DeletedDate", "Description", "DoctorID", "EmployeeID", "IsActive", "IsDeleted", "LastModifiedDate" },
                values: new object[,]
                {
                    { 1, new DateOnly(2023, 11, 12), new TimeOnly(12, 30, 0), 12, new DateTime(2024, 1, 8, 21, 54, 58, 966, DateTimeKind.Local).AddTicks(5179), null, "Regular Checkup", 1, 1, true, false, null },
                    { 2, new DateOnly(2023, 12, 13), new TimeOnly(13, 45, 0), 13, new DateTime(2024, 1, 8, 21, 54, 58, 966, DateTimeKind.Local).AddTicks(5197), null, "Regular Checkup", 2, 2, true, false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 8, 21, 54, 58, 966, DateTimeKind.Local).AddTicks(9878), 1, null, 1, new TimeSpan(0, 8, 20, 0, 0), true, false, null, new TimeSpan(0, 8, 0, 0, 0) },
                    { 2, new DateTime(2024, 1, 8, 21, 54, 58, 966, DateTimeKind.Local).AddTicks(9892), 2, null, 2, new TimeSpan(0, 8, 20, 0, 0), true, false, null, new TimeSpan(0, 8, 0, 0, 0) }
                });
