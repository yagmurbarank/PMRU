    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2024, 1, 8, 15, 27, 59, 719, DateTimeKind.Local).AddTicks(8543), null, 4, "ahmet.yilmaz@email.com", "5555123456", true, false, 34, "Ahmet", "(555) 512-3456", 4, "100", "Yılmaz" },
                    { 2, 0, new DateTime(2024, 1, 8, 15, 27, 59, 719, DateTimeKind.Local).AddTicks(8547), null, 4, "ayse.kaya@email.com", "5555234567", true, false, 41, "Ayşe", "(555) 523-4567", 3, "101", "Kaya" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 8, 0, 0, 0, 0, DateTimeKind.Local), "09:00", new DateTime(2024, 1, 8, 15, 27, 59, 719, DateTimeKind.Local).AddTicks(1905), null, "Regular Checkup", 1, 1, true, false, null },
                    { 2, new DateTime(2024, 1, 8, 0, 0, 0, 0, DateTimeKind.Local), "09:30", new DateTime(2024, 1, 8, 15, 27, 59, 719, DateTimeKind.Local).AddTicks(1931), null, "Regular Checkup", 2, 2, true, false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 8, 15, 27, 59, 719, DateTimeKind.Local).AddTicks(3966), 1, null, 1, new TimeSpan(0, 8, 20, 0, 0), true, false, null, new TimeSpan(0, 8, 0, 0, 0) },
                    { 2, new DateTime(2024, 1, 8, 15, 27, 59, 719, DateTimeKind.Local).AddTicks(3980), 2, null, 2, new TimeSpan(0, 8, 20, 0, 0), true, false, null, new TimeSpan(0, 8, 0, 0, 0) }
                });
